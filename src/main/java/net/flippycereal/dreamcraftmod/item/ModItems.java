...
public class ModItems {
    ...
    public static final Item ECHO_LONGSWORD = registerItem("echo_longsword",
            new EchoLongswordItem(ToolMaterials.NETHERITE, 5, -2.75f, new FabricItemSettings().fireproof().rarity(Rarity.EPIC).maxCount(1).maxDamage(-1)));
    public static final Item ECHO_AXE = registerItem("echo_axe",
            new EchoAxeItem(ToolMaterials.NETHERITE, 15, -3F, new FabricItemSettings().fireproof().rarity(Rarity.EPIC).maxCount(1).maxDamage(-1)));
    public static final Item PRIDE_SCYTHE = registerItem("pride_scythe",
            new PrideScytheItem(ToolMaterials.NETHERITE, 4, -2.4f, new FabricItemSettings().maxDamage(2031).rarity(Rarity.RARE)));
    public static final Item ECHO_GLAIVE = registerItem("echo_glaive",
            new EchoGlaiveItem(ToolMaterials.NETHERITE, 2, -1f, new FabricItemSettings().maxDamage(-1).maxCount(1).fireproof().rarity(Rarity.EPIC)));
    public static final Item ECHO_BLADE = registerItem("echo_blade",
            new AxeItem(ToolMaterials.NETHERITE, 0, 0, new FabricItemSettings().rarity(Rarity.RARE).maxCount(1)));
